...
export const configurationConflictSchema = z
  .object({
    key: z.string(),
...
export const syncQueueMetadataSchema = z
  .object({
...
export const syncStatusSyncedSchema = z
  .object({
...
export const syncStatusSyncingSchema = z
  .object({
    status: z.literal("syncing"),
  })
  .strict();

export const syncStatusOfflineSchema = z
  .object({
...
export const syncStatusConflictSchema = z
  .object({
...
export const syncStatusErrorSchema = z
  .object({
...
export const configurationInspectionSchema = z
  .object({
    key: z.string(),
